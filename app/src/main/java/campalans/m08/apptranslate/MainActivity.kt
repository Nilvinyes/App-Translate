...
import campalans.m08.apptranslate.API.retrofitService
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showSuccess() {
        runOnUiThread{
            Toast.makeText(this, "Petició Correcta", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private fun initView() {
        btnDetectLanguage = findViewById(R.id.btnDetectLanguaje)
